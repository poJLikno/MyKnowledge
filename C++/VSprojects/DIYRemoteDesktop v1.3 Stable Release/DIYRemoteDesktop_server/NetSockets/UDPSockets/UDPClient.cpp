...
{
	int sendOk = sendto(client, data, (int)size, 0, (sockaddr *)&serverInfo, sizeof(serverInfo));
...
{
	int bytesIn = recvfrom(client, buffer, (int)size, 0, (sockaddr *)&serverInfo, &serverLength);
