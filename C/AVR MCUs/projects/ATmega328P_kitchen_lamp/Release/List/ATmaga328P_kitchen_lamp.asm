...
_turn_on:
; .FSTART _turn_on
; 0001 0035 unsigned short i;
; 0001 0036 for (i = 0; i < (8 * 3 * led_count); i++)
	RCALL SUBOPT_0x1
;	led_count -> R18,R19
;	i -> R16,R17
_0x20004:
...
_turn_off:
; .FSTART _turn_off
; 0001 003E unsigned short i;
; 0001 003F for (i = 0; i < (8 * 3 * led_count); i++)
	RCALL SUBOPT_0x1
;	led_count -> R18,R19
;	i -> R16,R17
_0x20007:
