...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl='urn:schemas-microsoft-com:xslt'>
	<xsl:template match="/">
		<html>
          ...
          .success { background-color:#00CC00; color:#000000; margin-right:5px; }
          .failure { background-color:#CC0000; color:#000000; margin-right:5px; }
        ...
        <br />
        Please review the conversion log and make necessary changes if required to complete the migration.
        <br/>
        <br/>
